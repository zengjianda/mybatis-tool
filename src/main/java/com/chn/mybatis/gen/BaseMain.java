...
public class BaseMain {
	...
	public static final String ROOT_FILE_PATH = BaseMain.class.getResource("/").getPath().replace("%20", " ");
	public static final String PACKAGE_PATH = ROOT_FILE_PATH + "com/chn/mybatis/gen/tpl";

	//数据库连接
	public static String dbUrl = "jdbc:mysql://master.logis.galaxy.com:3555/logistics?characterEncoding=utf-8&allowMultiQueries=true";
	public static String username = "haoyaouser";
	public static String password = "QhgfO_LJf2LsM5F4A_7NmWb";
	public static String driver = "com.mysql.jdbc.Driver";

	//要初始化的表
	public static String[] tables = {"login_device"};


	public static File GEN_SERVICE_FOLDER = new File("F:/idea_workspace/java/base/base-all/base-business/src/main/java");//生成service文件目录

	public static File GEN_SERVICE_IMPL_FOLDER = new File("F:/idea_workspace/java/base/base-all/base-business-impl/src/main/java");//生成service实现类文件目录

	public static File GEN_XML_FOLDER = new File("F:/idea_workspace/java/base/base-all/base-business-impl/src/main/resources");//生成mapper文件目录


	public static final String GEN_PACKAGE = "com.galaxy.base";//项目根目录
